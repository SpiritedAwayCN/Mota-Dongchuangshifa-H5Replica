main.floors.MT33=
{
    ...
    "events": {
        "2,1": [
            "\t[老人,man]\b[this]天哪，你知道你闯过了多少机关么？",
            "\t[老人,man]\b[this]16个可随时要你命的机关！",
            "\t[hero,hero]\b[hero]那些机关在哪？",
            "\t[老人,man]\b[this]这个魔塔是个计时魔塔，每单数层都有一个计时器，你只能在奇数层最多呆一分钟，多了就会死。",
            "\t[hero,hero]\b[hero]哦。我可以走了么？",
            "\t[老人,man]\b[this]有惊无险，给你15把黄钥匙，3把蓝钥匙，快去开郁闷你很久的N扇门吧！",
            {
                "type": "setValue",
                "name": "item:yellowKey",
                "operator": "+=",
