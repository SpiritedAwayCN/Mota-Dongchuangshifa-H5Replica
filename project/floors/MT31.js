main.floors.MT31=
{
    ...
    "events": {
        ...
        "12,9": [
            "\t[老人,man]\b[this]这一层有个虚墙，你发现了么？",
            "\t[老人,man]\b[this]以后虚墙会难发现，就像这层的潜伏怪一样？",
            "\t[H5复刻作者]原版的潜伏怪完全不可见，H5复刻版统一半透明处理\n同时，物种探知器没有实际效果。",
            "\t[H5复刻作者]而虚墙将与原版一致，不再与普通的墙外观上有区别。",
            {
                "type": "hide",
                "remove": true
            }
    ...
    [20040,244,  1,226,  0,  0,  1,  1,  1,218,  1, 81,  1,  1,20042],
