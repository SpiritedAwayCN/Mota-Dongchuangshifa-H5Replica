main.floors.Tutorial1=
{
    ...
    "events": {
            ...
            "data": [
                ...
                },
                {
                    ...
                    "false": [
                        ...
                        "\t[老人,man]\b[this]一般情况下，拾取血瓶时将立刻回复生命值。但是，血瓶也可以\\d道具化\\d，存入背包以供日后使用。",
                        "\t[老人,man]\b[this]\r[lime]按下1键即可设置血瓶是否道具化！\r(手机玩家请点击下方\\i[toolbox]左起第3个图标进入道具栏，然后\r[lime]双击\\i[skill1]血瓶道具化图标\r进入界面)",
                        "\t[老人,man]\b[this]现在，\r[yellow]请将血瓶设置为\"道具化\"状态\r，这样获取血瓶时会存入背包，而不是直接使用。",
                        {
                            "type": "setValue",
                            "name": "switch:A",
                            "operator": "+=",
        ...
        "4,10": [
            {
                ...
                "true": [
                    "\t[老人,man]\b[down]注意到我右上方的这一堵颜色稍暗的墙了吗？",
        ...
        "3,12": [
            ...
            "\t[血网,lavaNet]\b[this,1,10]我是血网，踩上后，\r[#ff6060]扣除角色一定生命值\r，但不会给角色赋予异常状态。",
        ...
        "6,13": [
            ...
            },
            {
                ...
                "true": [
                    {
                        ...
                        "true": [
                            ...
                            "\t[老人,man]\b[this]比如，在刚刚配置难度的时候，你应该已经发现：\r[yellow]难度项“血网扣血效果+400%”不可选择\r。",
                            "\t[血网,lavaNet]\b[this,1,10]这是因为刚才经过了我这里，当时只扣除了100点生命。这\r[#FF60FF]与难度更高的效果\"血网扣血效果+400%\"相违背\r，所以这一项已经不可用了！",
                            "\t[老人,man]\b[this]但是，\r[yellow]您仍然可以选择更低的难度项\r，即“血网扣血效果-95%”，现在它已经生效了，向前走吧！",
                            {
                                "type": "move",
                                "time": 500,
                                "keep": true,
                ...
                "false": [
                    ...
                    "\t[老人,man]\b[this]但是，这点生命值是不足以通过我身后的三个血网的。借此机会，我将为你介绍本魔塔的\r[yellow]难度系统\r！",
                    "\t[老人,man]\b[this]难度系统，是本H5复刻版新增的功能，为了在原作的基础上增加一些挑战而设计。",
                    ...
                    "\t[老人,man]\b[this]除了\r[lime]按C键\r设置难度，直接\r[lime]在背包选择\\i[I337]难度设置图标\r也可进入相同的界面。现在，请\r[yellow]进入难度设置界面，将难度值调更低\r，使得你的生命值足够通过我身后的三个血网！",
                    {
                        "type": "setValue",
                        "name": "switch:A",
                        "operator": "+=",
        ...
        "10,13": [
            {
                        ...
                        "choices": [
                            ...
                            },
                            {
                                ...
                                "action": [
                                    ...
                                    "\t[老人,man]\b[this]比如，在刚刚配置难度的时候，你应该已经发现：\r[yellow]难度项“血网扣血效果+400%”不可选择\r。",
                                    "\t[血网,lavaNet]\b[this,1,10]这是因为刚才经过了我这里，当时只扣除了100点生命。这\r[#FF60FF]与难度更高的效果\"血网扣血效果+400%\"相违背\r，所以这一项已经不可用了！",
                                    "\t[血网,lavaNet]\b[this,7,13]而你在选择了难度更低的“血网扣血效果-95%”后通过了我这里，于是\r[#FF60FF]之前的\"血网扣血效果遵循原作\"也不可用了！",
                ...
                "false": [
                    "\t[老人,man]\b[this]刚刚经过路障的时候，由于更低的难度效果已生效，所以\r[#FF60FF]之前的难度项\"血网扣血效果遵循原作\"也不可用了\r！",
