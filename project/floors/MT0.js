main.floors.MT0=
{
    ...
    "events": {
        ...
        "8,5": [
            ...
            "\t[神秘老人,wizard]\b[this]尽管已尽可能接近原版，但复刻版仍非完美复刻。\n原版特性较多，不影响游戏进程的特性没有复刻。"
        ],
        "6,9": [
        ...
        "6,5": [
            ...
            },
            {
                ...
                "yes": [
                    ...
                    "\t[H5复刻作者]首次到达-3F会让角色丢失所有钥匙、药水、金币、经验，且重置角色能力为固定值。\n请适当留存资源，善用血瓶/宝石道具化。（据原作者Joey·Cooper在原版中透露的信息，不留也能过）",
                    ...
                    "\t[H5复刻作者]此外，难度配置可能影响玩法，因此部分难度（特别是与原版差异较大的难度选项）下NPC的提示不一定绝对正确，请留意。",
                    "\t[H5复刻作者]当然，原版魔塔有一定的解密成分，本复刻版在这些解密部分均加入了用于跳过的开关，不会影响难度与最终评分。但如果您想完整体验解密内容，请慎用跳过，这将丧失游戏性。"
                ],
                "no": []
            },
            {
