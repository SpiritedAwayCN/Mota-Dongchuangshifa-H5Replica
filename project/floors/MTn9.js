main.floors.MTn9=
{
                ...
                "choices": [
                    {
                        "text": "破甲or反击",
                        "action": [
                            "\t[老人,man]\b[this]赞成！这两个属性会永远费你血。支一个招：去掉一部分攻/防装备。我想你以前一定用过这个办法，没错吧。不过放心，以后这些怪物会变少的，你就不会这么麻烦了。@clue"
                        ]
                    },
                    {
                        "text": "魔攻or模仿",
                        "action": [
                            "\t[老人,man]\b[this]想法独特！魔攻的怪物的攻击不算太变态。主要是模仿。对付模仿怪物的窍门：去掉装备物品的防御。假如在-9F你是用困难打过的，那你一定用了这个办法，对么？@clue",
                            {
                                "type": "if",
                                "condition": "flag:VerboseHint",
                                "true": [
                                    "\t[H5复刻作者]对NPC的补充说明：对付模仿怪物的窍门——通过调整装备，控制攻防差到合适的数值。@clue"
                                ]
                            }
                        ]
                    },
                    {
                        "text": "中毒or衰弱",
                        "action": [
                            "\t[老人,man]\b[this]唉，解毒药及解衰药在-6F很全了，你还害怕这两个属性，你浪费了这个对话！@clue"
                        ]
                    }
                ]
            },
    ...
    "beforeBattle": {
        "9,1": [
            ...
            "\t[hero]\b[hero]不就是个连身子都没有的小头么......",
            "\t[红色史莱姆,redSlime]\b[this]哼，你不就是一个被人当作是怪物的勇士么......",
            "\t[hero]\b[hero]又来了，作者懒得弄选项了，我只接说吧，你又来了！我不会上当了！",
