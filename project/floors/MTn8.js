main.floors.MTn8=
{
    ...
    "events": {
        ...
        "3,14": [
            {
                "type": "confirm",
                "text": "有一些关于圣水的提示，是否查看？",
                "yes": [
                    "\t[H5复刻作者]本层NPC将赠送\\i[superPotion]圣水，使用后生命值能翻倍。",
                    "\t[H5复刻作者]而首次到达-23F时将清空背包中的全部圣水，请合理规划资源与使用时机。"
                ],
                "no": []
            }
        ]
    ...
    [20040,383, 34,385, 30,385, 33,214,  0,214,  0,214,  0,439,20042],
    ...
    [20048,20049,20049,129,20049,20049,20049,20049,20049,20049,20049,20049,20049,20049,20050]
],
    "bgmap": [
