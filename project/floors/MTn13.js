main.floors.MTn13=
{
    ...
    "events": {
        "12,6": [
            "\t[老人,man]\b[this]这种门可用通行证或用特殊钥匙开。",
            "\t[老人,man]\b[this]但是如果你有通行证，会先用通行证。",
            "\t[老人,man]\b[this]看见代闪电的东西了么，当你踩一些机关时，它们会发生一些变化。下一层的一样，不过样子不太一样。",
            "\t[老人,man]\b[this]你踩一些机关后，一些机关路表面不发生变化，不过性质可能变化。",
            {
                "type": "setValue",
                "name": "flag:v116_Chat",
                "operator": "+=",
    ...
    [20040, 86,  0,  0,  0, 86,  0,  0,  0, 86,  0,  0,  0, 86,20042],
    [20040, 86,  0,  0,  0,460,  0,  0,  0,  0,  0,  0,  0, 86,20042],
