main.floors.MTn20=
{
    ...
    "events": {
        ...
        "2,14": [
            {
                "type": "confirm",
                "text": "有一些关于钥匙与隐藏层的提示，是否查看？",
                "yes": [
                    "\t[H5复刻作者]进入右侧传送门后将解锁新的隐藏层，可在其中获得\\i[coin]幸运金币，效果为击杀敌方单位后获得的金币翻倍。",
                    "\t[H5复刻作者]同时，其中还有大量钥匙资源，而-26F将要求角色持有大量钥匙，请合理规划资源的使用。",
                    "\t[H5复刻作者]-27F的一位NPC可解锁无限次数的钥匙商店，此后钥匙资源将可永久通过金币换取。"
                ],
                "no": []
            }
        ]
