main.floors.MT13=
{
    ...
    "events": {
        ...
        "8,0": [
            {
                "type": "confirm",
                "text": "有一些关于本层小偷的提示，是否查看？\n（多次查看可能失去探索的乐趣）",
                "yes": [
                    "\t[H5复刻作者]需要破墙工具(或其他相关功能性宝物)营救小偷。",
                    "\t[H5复刻作者]小偷将赠送一些宝石、一把\\i[pickaxe]破墙镐，打开30F堵路的墙，同时12F钥匙商店将完成进货（刷新购买次数）。如果\r[#FF6060]先前没有把12F钥匙商店购买次数用完，会亏购买次数\r！"
                ],
                "no": []
            }
        ]
