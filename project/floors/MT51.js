main.floors.MT51=
{
    ...
    "events": {
        ...
        "0,13": [
            {
                "type": "confirm",
                "text": "有一些关于49F商店的信息，是否查看？\n（多次查看可能失去探索的乐趣）",
                "yes": [
                    "\t[H5复刻作者]经过50层魔王扣减能力后，49F商店已暂时涨价，但价格将在\r[lime]击杀71F下楼梯口的首个\\i[E528]暗黑蝙蝠后恢复！"
                ],
                "no": []
            },
            {
                "type": "confirm",
                "text": "有一些关于幸运金币的提示，是否查看？\n（多次查看可能失去探索的乐趣）",
                "yes": [
                    "\t[H5复刻作者]下一次获得\\i[coin]幸运金币的位置为：第84层。"
                ],
                "no": []
            }
        ]
    ...
    [129, 88,  0, 81, 22,  1,  1, 33,514,  1,  0,  0,  0, 87,20042],
