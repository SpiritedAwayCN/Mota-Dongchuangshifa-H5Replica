		...
		"values": {
			...
			"_data": {
				...
				"vampireGlobalRate": {
					...
					"_type": "textarea",
					"_docs": "吸血比例",
					"_data": "怪物吸血的百分比；可以用怪物的vampire覆盖此值。"
				},
				"vampireGlobalAdd": {
					"_leaf": true,
					"_type": "checkbox",
					"_docs": "吸血加给怪物",
					"_data": "吸血是否加给自身；为false时用怪物的add覆盖此值。"
				},
				"breakArmor": {
					"_leaf": true,
					"_type": "textarea",
				...
				"godThief": {
					...
					"_type": "textarea",
					"_docs": "神偷怪金币偷取率",
					"_data": "神偷属性中，战前偷取角色金币的比率"
				},
				"expThief": {
					"_leaf": true,
					"_type": "textarea",
					"_docs": "遗忘怪经验偷取率",
					"_data": "遗忘属性中，战前偷取角色经验的比率"
				},
				"degradeAtk": {
					"_leaf": true,
					"_type": "textarea",
					"_docs": "退化对攻效果",
					"_data": "退化属性中，战后角色丢失的攻击值（全局），可被怪物自身的属性覆盖。"
				},
				"degradeDef": {
					"_leaf": true,
					"_type": "textarea",
				...
				"isPotionItemized": {
					...
					"_type": "checkbox",
					"_docs": "血瓶是否道具化",
					"_data": "获得血瓶时是否按tools处理而非items，仅供插件用于判断"
				},
				"isGemItemized": {
					"_leaf": true,
					"_type": "checkbox",
					"_docs": "宝石是否道具化",
					"_data": "获得宝石时是否按tools处理而非items，仅供插件用于判断"
				},
				"isMAGValid": {
					"_leaf": true,
					"_type": "checkbox",
